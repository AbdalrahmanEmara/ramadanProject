...
function displayBooks() {
  ...
  books.forEach((book) => {
    ...
    bookItem.innerHTML = `
            ...
            <p>${book.name}</p>
            <a class="btn" href="${book.url}" target="_blank" >أقراء الكتاب</a>
        `;
  ...
  books.forEach((book) => {
    ...
    slide.innerHTML = `
          <div class="img-holder">
              <img src="${book.image}" alt="${book.name}" onerror="this.src='./imgs/default.png'"/>
          </div>
